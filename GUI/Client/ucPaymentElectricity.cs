...
namespace GUI.Client
{
    public partial class ucPaymentElectricity : UserControl
    {
        ...
        /// <summary>
        /// Sự kiện chạy khi bắt đầu mở giao diện Thanh toán Điện
        /// </summary>
        private void ucPaymentElectricity_Load(object sender, EventArgs e)
        {
            ...
            // 🌟 Đổ dữ liệu các công ty Điện (ServiceTypeID = 1) vào ComboBox
            ...
            // BẮT ĐẦU LOAD: Chỉ truyền số 1 (Dịch vụ ĐIỆN) xuống để lọc danh sách bên phải
            LoadPendingInvoices(1);
        }

        /// <summary>
        /// Hàm gọi BLL lấy dữ liệu hóa đơn điện và tự động vẽ lên panel bên phải
        /// </summary>
        private void LoadPendingInvoices(int serviceTypeId)
        {
            ...
            try
            {
                ...
                // Tiến hành chạy vòng lặp dựng các Card hóa đơn điện
                int yPosition = 10;
        ...
        /// <summary>
        /// Đổ ngược dữ liệu hóa đơn điện sang Form bên trái và mở rộng sang Trạng thái 2
        /// </summary>
