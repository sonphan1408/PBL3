        ...
        private void LoadPendingInvoices(int serviceTypeId)
        {
            ...
            try
            {
                ...
                if (unpaidWaterInvoices == null || unpaidWaterInvoices.Count == 0)
                {
                    ...
                    {
                        Text = "Bạn không có hóa đơn tiền nước nào cần thanh toán.",
        ...
        private void txtCustomerCode_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show("Không tìm thấy hóa đơn tiền nước chưa thanh toán nào khớp với mã trên hộ gia đình này!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        SetAdvancedFormVisible(false);
                    }
                }
                catch (Exception ex)
